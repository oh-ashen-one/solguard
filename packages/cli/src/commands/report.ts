...
<head>
  ...
  <title>SolShield AI Audit Report - ${data.programName}</title>
  <style>
...
<body>
  <div class="container">
    <header>
      ...
      <h1>SolShield AI Security Audit</h1>
    ...
    <footer>
      <p>Generated by <a href="https://github.com/oh-ashen-one/solshield">SolShield AI</a></p>
